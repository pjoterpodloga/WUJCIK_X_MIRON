...
#
# Generated by export_simulation on Thu Nov 14 18:04:36 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './fir_compiler_BP.sh' script.

./fir_compiler_BP.sh -reset_run
...
./fir_compiler_BP.sh -noclean_files

For more information on the script, please type './fir_compiler_BP.sh -help'.
